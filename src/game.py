...
class Game:
    def __init__(self, screen):
        ...
        self.walls_color = self.walls_colors[
    ...
    def collect_game(
        self, collect_type='start_over', life=3, level=1
    ):
        def clear():
            self.pacman = pygame.sprite.GroupSingle()
            self.ghosts = pygame.sprite.Group()
        ...
        self.walls_collide_list = [
            wall.rect for wall in self.walls.sprites()
        ]

        self.total_points = 0
        for dot in self.dots:
            self.total_points += 50 if dot.is_power else 10
    ...
    def draw(self):
        ...
        if self.is_pause:
            ...
            if self.power_mode:
                ...
                if (current_time - self.power_mode_start_time
